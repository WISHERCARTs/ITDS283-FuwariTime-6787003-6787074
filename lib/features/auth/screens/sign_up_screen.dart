                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // NAME FIELD
                          const Padding(
                            padding: EdgeInsets.only(left: 50, right: 29, bottom: 15),
                            child: TextField(
                              decoration: InputDecoration(
                                prefixIcon: Icon(Icons.person_outline, color: Color(0xFFB78403)),
                                hintText: "Name",
                                hintStyle: TextStyle(color: Color(0xFF888888), fontSize: 16),
                                enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Color(0x4FB78403))),
                                focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: Color(0xFFB78403), width: 2)),
                              ),
                            ),
                          ),
                          // EMAIL FIELD
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                try {
                                  ...
                                  if (response != null) {
                                    print('✅ สมัครสมาชิกด้วย Google สำเร็จ: ${response.user?.email}');
                                  }
                                } catch (e) {
                                  if (mounted) {
                                  ...
                                  print('❌ เกิดข้อผิดพลาดในการสมัครสมาชิกด้วย Google: $e');
                                }
                              },
                              child: Container(
                                alignment: Alignment.center,
